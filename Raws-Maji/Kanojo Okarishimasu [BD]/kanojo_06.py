...
JPBD = infos_bd(r'[BDMV] Rent-a-Girlfriend Volume 2\DMPXA133\BDMV\STREAM\00007', None, None)
...
def do_filter():
    ...
    import placebo
    deband_b = core.std.MaskedMerge(placebo.deband(deband, 20, 6, 2, 2), out, detail_light_mask)
