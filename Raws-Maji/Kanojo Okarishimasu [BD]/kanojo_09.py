...
JPBD = infos_bd(r'[BDMV][201223][Kanojo, Okarishimasu][Vol.03]\BD\BDMV\STREAM\00006', None, None)
...
def do_filter():
    ...
    deband = lvf.rfs(deband, deband_b, [(17700, 17803), (22056, 22088), (22136, 22170)])
