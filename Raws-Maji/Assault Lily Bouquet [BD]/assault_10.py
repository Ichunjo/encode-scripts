...
JPBD_NCED = FileInfo('[BDMV][210428][BRMM-10344][アサルトリリィ BOUQUET 4]/BRMM_10344/BDMV/STREAM/00003.m2ts', (None, None), preset=PresetBD)
...
class Filtering:
    def main(self) -> vs.VideoNode:
        ...
        if FILTER_ENDCARD:
            ...
            out = rfs(out, dehalo, [(34525, src.num_frames-1)])
