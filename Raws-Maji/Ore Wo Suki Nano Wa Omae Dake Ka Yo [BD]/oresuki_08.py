...
JPBD = infos_bd(r'[BDMV] ORESUKI Are you the only one who loves me\ORESUKI Volume 4\BD_VIDEO\BDMV\STREAM\00002', 0, -26)
...
def do_filter():
    ...
    decomb = lvf.rfs(out, decomb, [(4548, 4556)])
    ref = decomb
    out = decomb
    ...
    credit = lvf.rfs(out, core.std.MaskedMerge(out, antialias, credit_mask),
                     [(4553, 4652), (33926, src.num_frames-1), (41, 142)])
    out = credit
