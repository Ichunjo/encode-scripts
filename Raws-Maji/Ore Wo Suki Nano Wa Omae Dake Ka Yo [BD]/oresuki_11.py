...
JPBD = infos_bd(r'[BDMV] ORESUKI Are you the only one who loves me\ORESUKI Volume 6\BD_VIDEO\BDMV\STREAM\00001', 0, -26)
...
def do_filter():
    ...
    credit = lvf.rfs(out, core.std.MaskedMerge(out, antialias, credit_mask),
                     [(4396, 4484), (33924, src.num_frames-1), (11981, 12250), (12478, 12836)])
