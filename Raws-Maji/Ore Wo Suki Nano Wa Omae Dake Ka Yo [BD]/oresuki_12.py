...
JPBD = infos_bd(r'[BDMV] ORESUKI Are you the only one who loves me\ORESUKI Volume 6\BD_VIDEO\BDMV\STREAM\00002', 0, -24*5)
...
def do_filter():
    ...
    deband = lvf.rfs(deband, deband_c, [(23709, 23786), (30397, 30546), (31115, 31353)])
    ...
    credit = lvf.rfs(out, core.std.MaskedMerge(out, ref, credit_mask), [(0, 661), (26731, 34015)])
