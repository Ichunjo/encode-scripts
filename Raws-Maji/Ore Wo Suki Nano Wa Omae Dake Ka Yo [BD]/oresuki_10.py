...
JPBD = infos_bd(r'[BDMV] ORESUKI Are you the only one who loves me\ORESUKI Volume 5\BD_VIDEO\BDMV\STREAM\00002', 0, -26)
...
def do_filter():
    ...
    decomb = lvf.rfs(out, decomb, [(2595, 2603)])
    ref = decomb
    out = decomb
    ...
    credit = lvf.rfs(out, core.std.MaskedMerge(out, antialias, credit_mask),
                     [(2600, 2708), (33926, src.num_frames-1)])
