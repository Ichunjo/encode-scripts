...
JPBD = infos_bd(r'[BDMV] ORESUKI Are you the only one who loves me\ORESUKI Volume 5\BD_VIDEO\BDMV\STREAM\00001', 0, -26)
...
def do_filter():
    ...
    decomb = lvf.rfs(out, decomb, [(2618, 2626)])
    ref = decomb
    out = decomb
    ...
    regrain = lvf.rfs(out, regrain, [(11379, 11464), (11536, 11637), (12295, 12377)])
    out = regrain
    ...
    credit = lvf.rfs(out, core.std.MaskedMerge(out, antialias, credit_mask),
                     [(2619, 2719), (33926, src.num_frames-1)])
