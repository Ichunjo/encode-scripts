...
JPBD = infos_bd(r'REZERO_2ND_DISC2\BDMV\STREAM\00002', 0, 37641)
...
def do_filter():
    ...
    deband = lvf.rfs(deband, deband_d, [(1438, 8052), (8286, 9384)])
    ...
    credit = lvf.rfs(out, core.std.MaskedMerge(out, ref, credit_mask, 0), [(60, 1257), (35220, 37521)])
    credit = lvf.rfs(credit, ref, [(1320, 1437), (37522, src.num_frames-1)])
    out = credit
