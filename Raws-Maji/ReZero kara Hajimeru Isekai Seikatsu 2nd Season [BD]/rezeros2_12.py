...
JPBD = infos_bd(r'REZERO_2ND_DISC4\BDMV\STREAM\00010', 0, 38839)
...
def do_filter():
    ...
    credit = out
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, credit_mask, 0), [(49, 1151), (34762, 38766)])
    credit = lvf.rfs(credit, ref, [(1152, 1271), (38767, src.num_frames-1)])
    out = credit
