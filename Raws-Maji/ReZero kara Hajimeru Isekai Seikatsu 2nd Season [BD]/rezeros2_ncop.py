...
JPBD = infos_bd(r'REZERO_2ND_DISC1\BDMV\STREAM\00018', 0, -24)
...
def mask_opening(ref: vs.VideoNode)-> vs.VideoNode:
    ...
    return mask + ref.std.BlankClip(format=vs.GRAY16, length=ref.num_frames - mask.num_frames)
