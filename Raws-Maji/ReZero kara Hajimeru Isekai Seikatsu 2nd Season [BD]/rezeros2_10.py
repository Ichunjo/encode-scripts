...
JPBD = infos_bd(r'REZERO_2ND_DISC3\BDMV\STREAM\00003', 0, 38120)
...
def do_filter():
    ...
    credit = out
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, credit_mask, 0), [(0, 2157), (32864, 35203), (38048, src.num_frames-1)])
    credit = lvf.rfs(credit, ref, [(2158, 2277), (35204, 35275)])
    out = credit
