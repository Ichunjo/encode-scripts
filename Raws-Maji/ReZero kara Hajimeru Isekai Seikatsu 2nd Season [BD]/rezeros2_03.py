...
JPBD = infos_bd(r'REZERO_2ND_DISC1\BDMV\STREAM\00003', 0, 36684)
...
def do_filter():
    ...
    credit = lvf.rfs(out, core.std.MaskedMerge(out, ref, credit_mask, 0), [(0, 695), (33994, 35959), (36559, 36611)])
    credit = lvf.rfs(credit, ref, [(696, 815), (36612, 36683)])
    out = credit
