...
JPBD = infos_bd(r'REZERO_2ND_DISC4\BDMV\STREAM\00009', 0, 37640)
...
def do_filter():
    ...
    credit = out
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, credit_mask, 0), [(0, 1748), (33273, 35331)])
    credit = lvf.rfs(credit, ref, [(1749, 1868), (37568, src.num_frames-1)])
    out = credit
