...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190918][TBR29113D][Fairy gone フェアリーゴーン Vol.3]\BDROM\BDMV\STREAM\00002', 24, -24)
...
def do_filter():
    ...
    eptitle_s, eptitle_e = 3861, 3980
    edstart, edend = 29684, 31840
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(146, 237), (1257, 1361), (5139, 5198), (5502, 5560), (6831, 6890),
                      (9338, 9396), (10264, 10344), (12988, 13046), (13988, 14035), (24407, 24497), 
                      (edstart, edend)]
                     )
