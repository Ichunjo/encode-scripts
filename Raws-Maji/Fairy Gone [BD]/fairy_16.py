...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][200122][TBR29116D][Fairy gone フェアリーゴーン Vol.6]\BDROM\BDMV\STREAM\00000', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 1534, 3692
    eptitle_s, eptitle_e = 3693, 3812
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(42, 155), (4259, 4317), (5229, 5324), (5541, 5636), (8596, 8752),
                     (10463, 10509), (12512, 12595),
                      (edstart, edend)]
                     )
