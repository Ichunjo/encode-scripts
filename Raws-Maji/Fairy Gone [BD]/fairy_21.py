...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][200219][TBR29117D][Fairy gone フェアリーゴーン Vol.7]\BDROM\BDMV\STREAM\00002', 24, -24)
...
def do_filter():
    ...
    # Variables
    eptitle_s, eptitle_e = 3261, 3380
    edstart, edend = 30594, 32750
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(210, 3159), (3512, 3568), (4411, 4464), (8355, 8414),
                      (edstart, edend)]
                     )
