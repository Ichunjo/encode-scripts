...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190918][TBR29113D][Fairy gone フェアリーゴーン Vol.3]\BDROM\BDMV\STREAM\00001', 24, -24)
...
def do_filter():
    ...
    eptitle_s, eptitle_e = 2158, 2277
    edstart, edend = 30737, 32893
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(2316, 2385), (5202, 5260), (12025, 12071), (13609, 13662),
                      (14431, 14489), (15334, 15506), (17831, 17865), (17977, 18017),
                      (18496, 18553), (32914, 32940),
                      (edstart, edend)]
                     )
