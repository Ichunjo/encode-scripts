...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190717][TBR29111D][Fairy gone フェアリーゴーン Vol.1]\BDROM\BDMV\STREAM\00000', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 4819, 6976
    eptitle_s, eptitle_e = 6977, 7096
    edstart, edend = 30618, 32774
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(112, 291), (808, 866), (2385, 2443), (7136, 7315), (edstart, edend)])
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, dehalo_ref, dehalo_mask, 0),
                     [(112, 291), (808, 866), (2385, 2443), (7136, 7315)])
    out = credit
