...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190821][TBR29112D][Fairy gone フェアリーゴーン Vol.2]\BDROM\BDMV\STREAM\00001', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 6281, 8439
    eptitle_s, eptitle_e = 8440, 8559
    edstart, edend = 30714, 32870
    ...
    credit = out
    dehalo_range_a = [(18, 106), (2901, 2982), (3259, 3322), (3640, 3752)]
    dehalo_range_b = [(20914, 20978)]
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(107, 165), (4970, 5016), (22135, 22219), (24912, 24988), (27658, 27754),
                      (27969, 28056),
                      (edstart, edend)]
