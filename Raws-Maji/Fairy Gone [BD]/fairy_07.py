...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190918][TBR29113D][Fairy gone フェアリーゴーン Vol.3]\BDROM\BDMV\STREAM\00000', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 2806, 4962
    eptitle_s, eptitle_e = 4963, 5082
    edstart, edend = 30762, 32918
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(44, 106), (1454, 1485), (2143, 2250), (5448, 5501), (5563, 5639),
                     (6472, 6551), (7728, 7836), (10103, 10161), (11926, 11972), (15642, 15780),
                      (edstart, edend)]
                     )
