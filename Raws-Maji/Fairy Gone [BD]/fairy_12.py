...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][191016][TBR29114D][Fairy gone フェアリーゴーン Vol.4]\BDROM\BDMV\STREAM\00002', 24, -24)
...
def do_filter():
    ...
    deband_b = dumb3kdbv2(out, 22, 80)
    deband = lvf.rfs(deband, deband_b, [(25163, 25194)])
    ...
    return depth(out, 10).std.Limiter(16<<2, [235<<2, 240<<2])[25163:25194+1]
