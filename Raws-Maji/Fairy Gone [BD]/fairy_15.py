...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][191218][TBR29115D][Fairy gone フェアリーゴーン Vol.5]\BDROM\BDMV\STREAM\00002', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 3597, 5754
    eptitle_s, eptitle_e = 5755, 5874
    edstart, edend = 30474, 32632
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(7258, 7302), (12039, 12138), (17987, 18033), (18676, 18727),
                     (22900, 22944),
                      (edstart, edend)]
                     + dehalo_range_a)
