...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190717][TBR29111D][Fairy gone フェアリーゴーン Vol.1]\BDROM\BDMV\STREAM\00001', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 5275, 7431
    eptitle_s, eptitle_e = 7432, 7551
    ...
    dehalo_mask = vdf.region_mask(rescale_mask, top=650)


    credit = out
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(35, 243), (474, 664), (1472, 1516), (1541, 1626), (2103, 2173),
                      (2461, 2567), (7561, 7702), (7727, 7781), (8767, 9028), (10258, 10316),
                      (13730, 13801), (14457, 14515), (14696, 14742), (20274, 20321),
                      (edstart, edend)])
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, dehalo_ref, dehalo_mask, 0),
                     [(35, 243), (474, 664), (1472, 1516), (2103, 2173), (2461, 2567),
                      (7561, 7702), (13730, 13801)])
    out = credit
