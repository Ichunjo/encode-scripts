...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190821][TBR29112D][Fairy gone フェアリーゴーン Vol.2]\BDROM\BDMV\STREAM\00002', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 4173, 6328
    eptitle_s, eptitle_e = 6329, 6448
    edstart, edend = 30832, 32988
    preview_s, preview_e = 33685, src.num_frames-1
    h = 720
    w = get_w(h)
    ...
    credit = out
    dehalo_range_a = [(18, 126), (13259, 13336)]
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(435, 537), (1019, 1145), (1289, 1415), (1595, 1729), (3877, 3928),
                     (4098, 4172), (6461, 6509), (10932, 11037), (11293, 11402), (14160, 14210),
                     (19004, 19092), (27129, 27175),
                      (edstart, edend)]
                     + dehalo_range_a)
