...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][190821][TBR29112D][Fairy gone フェアリーゴーン Vol.2]\BDROM\BDMV\STREAM\00000', 24, -24)
...
def do_filter():
    ...
    # Variables
    opstart, opend = 3909, 6064
    eptitle_s, eptitle_e = 6065, 6184
    edstart, edend = 31527, 33684
    ...
    credit = out
    # dehalo_range_a = [(0, 1)]
    dehalo_range_b = [(8995, 9055), (10310, 10399)]
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(6375, 6440), (7460, 7518), (10682, 10767), (11945, 11991),
                     (26468, 26530), (28422, 28536),
                     (edstart, edend)]
                     + dehalo_range_b)
