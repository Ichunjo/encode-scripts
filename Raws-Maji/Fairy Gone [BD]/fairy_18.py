...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][200122][TBR29116D][Fairy gone フェアリーゴーン Vol.6]\BDROM\BDMV\STREAM\00002', 24, -24)
...
def do_filter():
    ...
    eptitle_s, eptitle_e = 5011, 5130
    edstart, edend = 29874, 32032
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(48, 82), (5155, 5202), (6541, 6576), (19126, 19205),
                      (edstart, edend)]
                     )
