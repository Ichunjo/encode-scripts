...
JPBD = infos_bd(r'[BDMV] Fairy gone\[BDMV][191016][TBR29114D][Fairy gone フェアリーゴーン Vol.4]\BDROM\BDMV\STREAM\00000', 24, -24)
...
def do_filter():
    ...
    # Variables
    eptitle_s, eptitle_e = 2686, 2805
    edstart, edend = 30043, 32201
    ...
    credit = out
    dehalo_range_a = [(10321, 10446), (11531, 11689)]
    dehalo_range_b = [(18781, 18857)]
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(170, 2685), (11253, 11311), (12294, 12352), (15599, 15657),
                      (15888, 15970), (19203, 19241),
                      (edstart, edend)]
