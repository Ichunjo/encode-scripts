...
JPBD = infos_bd(r'[BDMV][Rifle is Beautiful][Blu-Ray BOX BDx4+CDx2 Fin]\RIFLE_IS_BEAUTIFUL_BDBOX1_D1\BDMV\STREAM\00006', 24, -24)
X265 = 'x265'
...
def do_encode(clip: vs.VideoNode)-> None:
    ...
    if not os.path.isfile(JPBD.a_enc_cut.format(1)):
        ...
        qaac_args = ['qaac', JPBD.a_src.format(1), '-V', '127', *qaac_args, '-o', JPBD.a_enc_cut.format(1)]
