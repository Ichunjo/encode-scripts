...
JPBD = infos_bd(r'[BDMV][Rifle is Beautiful][Blu-Ray BOX BDx4+CDx2 Fin]\RIFLE_IS_BEAUTIFUL_BDBOX2_D3\BDMV\STREAM\00002', 0, -24)
...
def do_filter():
    ...
    antialias_b = TAAmbk(antialias_b, aatype='Eedi3SangNom', cycle=4, thin=2, sharp=100, mtype=0, down8=False)
