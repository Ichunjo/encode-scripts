...
JPBD = infos_bd(r'[BDMV][201028][GNXA-2291][Lapis_Re_LiGHTs][vol.1]\LAPIS_RE_LIGHTS_1\BDMV\STREAM\00008', 0, 34047)
...
def do_filter():
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(opstart, opend), (4019, 4138)])
    credit = lvf.rfs(credit, ref, [(16280, 16399)])
    out = credit
