...
JPBD = infos_bd(r'[BDMV][201125][GNXA-2292][Lapis_Re_LiGHTs][vol.2]\LAPIS_RE_LIGHTS_2\BDMV\STREAM\00005', 0, 34070)
...
def do_filter():
    ...
    opstart, opend = 864, 3020
    edstart, edend = 31116, src.num_frames-1
    h = 846
    w = get_w(h)
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(opstart, opend), (3143, 3229), (edstart, edend), (13819, 13977)])
    out = credit
