...
JPBD = infos_bd(r'[BDMV][201223][GNXA-2293][Lapis_Re_LiGHTs][vol.3 Fin]\LAPIS_RE_LIGHTS_3\BDMV\STREAM\00022', 24, 2407)
...
def do_filter():
    ...
    credit = lvf.rfs(credit, ref, [(312, 466), (2276, src.num_frames-1)])
    out = credit
