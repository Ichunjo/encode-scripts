...
JPBD = infos_bd(r'[BDMV][201125][GNXA-2292][Lapis_Re_LiGHTs][vol.2]\LAPIS_RE_LIGHTS_2\BDMV\STREAM\00008', 0, 34048)
...
def do_filter():
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(opstart, opend), (4148, 4255), (edstart, edend)])
    credit = lvf.rfs(credit, ref, [(16976, 17095)])
    out = credit
