...
JPBD = infos_bd(r'[BDMV][201028][GNXA-2291][Lapis_Re_LiGHTs][vol.1]\LAPIS_RE_LIGHTS_1\BDMV\STREAM\00005', 0, 34047)
...
def do_filter():
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(opstart, opend), (3797, 3892)])
    credit = lvf.rfs(credit, ref, [(16400, 16519)])
    out = credit
