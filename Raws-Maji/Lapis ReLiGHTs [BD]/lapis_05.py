...
JPBD = infos_bd(r'[BDMV][201125][GNXA-2292][Lapis_Re_LiGHTs][vol.2]\LAPIS_RE_LIGHTS_2\BDMV\STREAM\00004', 0, 34047)
...
def do_filter():
    ...
    # Very bad halo
    dehalo_a = gf.MaskedDHA(out, rx=2.75, ry=2.75, darkstr=0.25, brightstr=1.0, maskpull=48, maskpush=140)
    dehalo_a = core.std.MaskedMerge(out, dehalo_a, lvf.src('lapis_05_halomask_1.png', out))
    dehalo_b = gf.MaskedDHA(out, rx=2.25, ry=2.25, darkstr=0.25, brightstr=1.0, maskpull=48, maskpush=140)
    dehalo = lvf.rfs(out, dehalo_a, [(11677, 11765)])
    dehalo = lvf.rfs(dehalo, dehalo_b, [(20509, 20690), (21242, 21276), (25834, 25856),
                                        (26614, 26648), (26682, 26761), (27685, 27719),
    ...
    deband_b = core.f3kdb.Deband(pf, 17, 48, 48, 48, 12, 12, 2, keep_tv_range=True, output_depth=16)
