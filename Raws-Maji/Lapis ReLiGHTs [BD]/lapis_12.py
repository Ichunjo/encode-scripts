...
JPBD = infos_bd(r'[BDMV][201223][GNXA-2293][Lapis_Re_LiGHTs][vol.3 Fin]\LAPIS_RE_LIGHTS_3\BDMV\STREAM\00009', 0, 34047)
...
def do_filter():
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask, 0),
                     [(1658, 1834), (30756, 31541), (33533, src.num_frames)])
    credit = lvf.rfs(credit, ref, [(31704, 33468)])
    out = credit
