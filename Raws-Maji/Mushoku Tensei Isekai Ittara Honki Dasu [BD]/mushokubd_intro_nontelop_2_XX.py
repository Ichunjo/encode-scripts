...
JPBDS = [
    FileInfo(
        r'[BDMV]Mushoku Tensei[Vol.2][JP]\BDROM\BDMV\STREAM\00006.m2ts', 24, None,
        preset=[PresetBD, PresetAAC]
    ),
    FileInfo(
        r'[BDMV]Mushoku Tensei[Vol.2][JP]\BDROM\BDMV\STREAM\00007.m2ts', 24, None,
        preset=[PresetBD, PresetAAC]
    ),
    FileInfo(
        r'[BDMV]Mushoku Tensei[Vol.2][JP]\BDROM\BDMV\STREAM\00008.m2ts', 24, None,
        preset=[PresetBD, PresetAAC]
    ),
    FileInfo(
        r'[BDMV]Mushoku Tensei[Vol.2][JP]\BDROM\BDMV\STREAM\00009.m2ts', None, -24,
        preset=[PresetBD, PresetAAC]
    ),
    FileInfo(
        r'[BDMV]Mushoku Tensei[Vol.2][JP]\BDROM\BDMV\STREAM\00010.m2ts', 24, None,
        preset=[PresetBD, PresetAAC]
    ),
    FileInfo(
        r'[BDMV]Mushoku Tensei[Vol.2][JP]\BDROM\BDMV\STREAM\00011.m2ts', 24, None,
        preset=[PresetBD, PresetAAC]
    ),
    FileInfo(
        r'[BDMV]Mushoku Tensei[Vol.2][JP]\BDROM\BDMV\STREAM\00012.m2ts', 24, None,
        preset=[PresetBD, PresetAAC]
    ),
]

NUM = ['06', '07', '08_part1', '08_part2', '09', '10', '11']
...
if __name__ == '__main__':
    for JPBD, n in zip(JPBDS, NUM):
        JPBD.name = f'mushokubd_intro_nontelop_2_{n}'
    ...
    # JPBDS[0].clip_cut.set_output(0)
    for i, JPBD in enumerate(JPBDS):
        JPBD.clip_cut.set_output(i)
