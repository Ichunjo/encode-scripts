...
JPBD = FileInfoMore(
    r'[BDMV][210326] ラブライブ! 虹ヶ咲学園スクールアイドル同好会 4\BDROM\BDMV\STREAM\00005.m2ts', 24, -26,
...
class Filtering():  # noqa
    def main(self: Filtering) -> vs.VideoNode:
        ...
        h = 800  # noqa
        w = get_w(h)  # noqa
        opstart, opend = 3213, 5370
        edstart, edend = 31480, 33637
        ...
        deband_a = vdf.deband.dumb3kdb(out, 17, 40)
        deband = lvf.rfs(deband, deband_a, [(5613, 5705), (17127, 17233), (22436, 22683)])
