...
JPBD = FileInfoMore(
    r'[BDMV][210225] ラブライブ! 虹ヶ咲学園スクールアイドル同好会 3\BDROM\BDMV\STREAM\00005.m2ts', 24, -27,
...
# h = 800
# w = get_w(h)
# opstart, opend = 2854, 5010
# edstart, edend = 30784, 32940



# deband = vdf.deband.dumb3kdb(out, 16, [33, 1], sample_mode=4, use_neo=True)
# deband_a = vdf.deband.dumb3kdb(out, 17, 40)
# deband = lvf.rfs(deband, deband_a, [(27949, 27993)])



# endcard = out + out[31061] * 121
# out = endcard
