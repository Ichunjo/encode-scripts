...
JPBD = FileInfoMore(
    r'[BDMV][210127][BCXA-1591][ラブライブ！虹ヶ咲学園スクールアイドル同好会][第2巻]\BDROM\BDMV\STREAM\00008.m2ts', 0, -26,
...
class Filtering():  # noqa
    def main(self: Filtering) -> vs.VideoNode:
        ...
        deband = lvf.rfs(deband, deband_a, [(12846, 12886), (26962, 27029), (34021, 34045)])
