...
JPBD = FileInfoMore(
    r'[BDMV][210225] ラブライブ! 虹ヶ咲学園スクールアイドル同好会 3\BDROM\BDMV\STREAM\00008.m2ts', 0, -25,
...
class Filtering():  # noqa
    def main(self: Filtering) -> vs.VideoNode:
        ...
        deband = lvf.rfs(deband, deband_a, [(23548, 24112), (24636, 24932), (25785, 26052)])
