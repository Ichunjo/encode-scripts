...
JPBD = FileInfoMore(
    r'[BDMV][210427] ラブライブ! 虹ヶ咲学園スクールアイドル同好会 5\BDROM\BDMV\STREAM\00005.m2ts', 24, -26,
...
class Filtering():  # noqa
    def main(self: Filtering) -> vs.VideoNode:
        ...
        h = 800  # noqa
        w = get_w(h)  # noqa
        opstart, opend = 3717, 5873
        edstart, edend = 31432, 33589
        ...
        deband_a = vdf.placebo.deband(out, 20.0, 4.0, 3, 0.0, False)
        deband = lvf.rfs(deband, deband_a, [(30673, 30755)])
