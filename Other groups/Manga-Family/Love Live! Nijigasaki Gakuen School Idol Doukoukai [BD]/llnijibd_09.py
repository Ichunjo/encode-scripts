...
JPBD = FileInfoMore(
    r'[BDMV][210427] ラブライブ! 虹ヶ咲学園スクールアイドル同好会 5\BDROM\BDMV\STREAM\00008.m2ts', 0, -25,
...
class Filtering():  # noqa
    def main(self: Filtering) -> vs.VideoNode:
        ...
        deband_a = vdf.placebo.deband(out, threshold=6.0, grain=0.0)
        deband = lvf.rfs(deband, deband_a, [(21254, 21330), (27023, 27093)])
