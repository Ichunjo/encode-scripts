...
JPBD = infos_bd(r'[昨日之歌][Yesterday o Utatte][イエスタデイをうたって][BDMV][1080P][DISC×3 Fin][Rev]\SING_YESTERDAY_FOR_ME_DISC2\BDMV\STREAM\00016', 0, -27)
...
def do_filter():
    ...
    ending = lvf.rfs(out, src, [(31240, src.num_frames-1)])
    out = ending
