...
JPBD = infos_bd(r'[昨日之歌][Yesterday o Utatte][イエスタデイをうたって][BDMV][1080P][DISC×3 Fin][Rev]\SING_YESTERDAY_FOR_ME_DISC3\BDMV\STREAM\00023', 24, -24)
...
def do_filter():
    ...
    cred = lvf.rfs(out, core.std.MaskedMerge(antialias_ed, src, lvf.src('spe_mask/06.png', src)[0]),
