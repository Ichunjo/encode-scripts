...
JPBD_NCED = FileInfo(
    BDMV_FOLDER / SUB_BDMV_FOLDER / 'BDMV/STREAM/00007.m2ts',
    (0, -24)
)
OPSTART, OPEND = 4915, 7073
EDSTART, EDEND = 32657, 34815
...
class Filtering:
    ...
    def main(self, src: vs.VideoNode = JPBD.clip_cut, debug: DebugOutput = DEBUG) -> vs.VideoNode:
        ...
        credit = replace_ranges(credit, core.std.MaskedMerge(credit, ref, rescale_mask), [(24566, 25910)])
        ...
        deband_b = dumb3kdb(out, 20, [49, 80], 24)
        deband = replace_ranges(deband, deband_b, [(14730, 14853)])
