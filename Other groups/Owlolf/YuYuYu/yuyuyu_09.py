...
OPSTART, OPEND = 1032, 3189
EDSTART, EDEND = 31479, 33541
...
class Filtering:
    ...
    def main(self, debug: DebugOutput = DEBUG) -> vs.VideoNode:
        ...
        # den_y_b = Denoise.bm3d(get_y(out), [5, 0, 0], radius=1, profile='fast', ref=get_y(ccd))
        # den_y = remap_rfs(den_y, den_y_b, [(20440, 21698)])
        ...
        # deband = remap_rfs(deband, deband_b, [(20440, 21698)])
