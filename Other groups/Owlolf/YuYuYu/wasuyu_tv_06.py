...
JPBD = FileInfo(
    ...
    (0, -23), preset=[PresetBD, PresetAAC], workdir='__workdir'
)
...
class Filtering:
    ...
    def main(self, src: vs.VideoNode = JPBD.clip_cut, debug: DebugOutput = DEBUG) -> vs.VideoNode:
        ...
        credit = remap_rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask), [(664, 1279), (1982, 2463)])
        credit = remap_rfs(credit, core.std.MaskedMerge(credit, ref, nc_mask), [(EDSTART, EDEND)])
        out = credit
