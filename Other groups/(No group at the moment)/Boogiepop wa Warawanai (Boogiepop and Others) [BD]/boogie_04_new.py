...
JPBD = src_file(
    r'[BDMV][アニメ] ブギーポップは笑わない (2019) [BD Vol.1-5][FIN]\BOOGIEPOP_AND_OTHERS_2\BDMV\STREAM\00000.m2ts',
    force_lsmas=True, trim=(24, -24)
)

EPISODE = '04'
(OPSTART, OPEND) = (2734, 4891)
(EDSTART, EDEND) = (31887, JPBD.src_cut.num_frames)
...
def main() -> vs.VideoNode:
    ...
    # Scenefiltering
    db = replace_ranges(db, db_weak, [(1321, 1363), (18091, 18179)], exclusive=True)
    db = replace_ranges(db, db_strg, [(18448, 18484), (27278, 27383), (28236, 28370)], exclusive=True)
