...
JPBD = src_file(
    r'[BDMV][アニメ] ブギーポップは笑わない (2019) [BD Vol.1-5][FIN]\BOOGIEPOP_AND_OTHERS_5\BDMV\STREAM\00000.m2ts',
...
def main() -> vs.VideoNode:
    ...
    rs.doubled = replace_ranges(doubled, aa, [(18348, 18492), ], exclusive=True)
    ...
    # Scenefiltering
    db = replace_ranges(db, db_strg, [(21351, 21399), ], exclusive=True)
