...
JPBD = src_file(
    r'[BDMV][アニメ] ブギーポップは笑わない (2019) [BD Vol.1-5][FIN]\BOOGIEPOP_AND_OTHERS_5\BDMV\STREAM\00003.m2ts',
...
def main() -> vs.VideoNode:
    ...
    bruteforce = nl_means(den, 8.0, tr=0, sr=3, simr=4, planes=0, num_streams=8)
    out = den
    ...
    # Scenefiltering
    db = replace_ranges(db, db_strg, [(18547, 18637), (22083, 22391), (24187, 24277), ], exclusive=True)
    db = replace_ranges(db, db_strg2, [(15220, 15305), (26416, 26512), (28996, 29146), (29752, 29830)], exclusive=True)
