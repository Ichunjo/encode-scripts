...
JPBD = src_file(
    r'[BDMV][アニメ] ブギーポップは笑わない (2019) [BD Vol.1-5][FIN]\BOOGIEPOP_AND_OTHERS_3\BDMV\STREAM\00000.m2ts',
    force_lsmas=True, trim=(24, -24)
)

EPISODE = '07'
(OPSTART, OPEND) = (2566, 4723)
...
def main() -> vs.VideoNode:
    ...
    rs.doubled = replace_ranges(doubled, aa, [(24513, 24765)], exclusive=True)
    ...
    # Scenefiltering
    db = replace_ranges(db, db_strg, [(14631, 14775), (21158, 21369)], exclusive=True)
    db = replace_ranges(db, db_strg2, [(21369, 21462), (21656, 21968), (26111, 26243), (26336, 26366)], exclusive=True)
    # 
