...
def do_filter():
    ...
    # Variables
    opstart, opend = 816, 2972
    edstart, edend = 30954, 33110
    full_zone = [(13427, 13474), (30894, 30953), (33987, src.num_frames-1)] # eyecatch, episode name and next episode
