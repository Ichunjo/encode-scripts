...
def do_filter():
    ...
    # Variables
    opstart, opend = 3429, 5587
    edstart, edend = 31651, 33810
    full_zone = [(16667, 16714), (31591, 31650), (33991, src.num_frames-1)] # eyecatch, episode name and next episode
