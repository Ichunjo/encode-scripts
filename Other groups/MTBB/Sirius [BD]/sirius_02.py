...
def do_filter():
    ...
    full_zone = [(18461, 18508), (31588, 31647), (33988, src.num_frames-1)] # eyecatch, episode name and next episode
    ...
    deband_b = rkt.rekt_fast(out, lambda c: dbs.f3kbilateral(c, 22, 120, 120).grain.Add(0.2, 0.15),
                             left=376, right=1062, bottom=500)
