...
JPBD = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00009', 24, -25)
JPBD_NCOP = infos_bd(r'[BDMV][190424][Tate no Yuusha no Nariagari][Vol.1]\TATE_1_2\BDMV\STREAM\00013', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 1\[BDMV] Rising_Shield_Hero_S1P1_D2\BDMV\STREAM\00018', 24, -24)
...
def do_filter():
    ...
    deband_e = deband_strong(deband_b)
    deband_f = placebo.Deband(deband_b, radius=24, threshold=8, iterations=1, grain=4)
    deband = lvf.rfs(deband_a, deband_b, [(opstart, opstart+146), (24942, 25004)])
    deband = lvf.rfs(deband, deband_c, [(opstart+1225, opstart+1238)])
    deband = lvf.rfs(deband, deband_d, [(opstart+970, opstart+984), (20760, 20950)])
    deband = lvf.rfs(deband, deband_e, [(19836, 19942)])
    deband = lvf.rfs(deband, deband_f, [(24874, 24941)])
    ...
    grain = lvf.rfs(grain, grain_original, [(20402, 20664)])
