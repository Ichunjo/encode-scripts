...
JPBD = infos_bd(r'[BDMV][190724][Tate no Yuusha no Nariagari][Vol.4 Fin]\TATE_4_2\BDMV\STREAM\00010', 0, -26)
JPBD_NCOP = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00012', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 2\[BDMV] Rising_Shield_Hero_S1P2_D2\BDMV\STREAM\00016', 24, -24)
...
def do_filter():
    ...
    opstart, opend = 0, 2169
    edstart, edend = 31780, 33937
    src = JPBD.src_cut
    src = depth(src, 16)
    ...
    grain = lvf.rfs(grain, grain_original, [(2420, 3596), (5356, 5488)])
    ...
    final = final[opstart+1:opstart+2160] + final[opend+1:]
...
def do_encode(filtered):
    ...
    src_cut = JPBD.src_cut[OPSTART+1:OPSTART+2160] + JPBD.src_cut[OPEND+1:]
    ...
    print('\n\n\nAudio cutting')
    eztrim(USBD.src_clip, [(USBD.frame_start+OPSTART+1, USBD.frame_start+OPSTART+2160),
