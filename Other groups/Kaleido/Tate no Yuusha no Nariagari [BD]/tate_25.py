...
JPBD = infos_bd(r'[BDMV][190724][Tate no Yuusha no Nariagari][Vol.4 Fin]\TATE_4_2\BDMV\STREAM\00011', 0, -24)
JPBD_NCOP = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00012', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 2\[BDMV] Rising_Shield_Hero_S1P2_D2\BDMV\STREAM\00017', 24, -24)
...
def do_filter():
    ...
    antialias_merged = lvf.rfs(antialias_merged, denoise, [(4603, 4722)])
    ...
    grain = lvf.rfs(grain, grain_original, [(16309, 16664), (18093, 18216)])
