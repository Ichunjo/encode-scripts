...
JPBD = infos_bd(r'[BDMV][190626][Tate no Yuusha no Nariagari][Vol.3]\TATE_3_2\BDMV\STREAM\00010', 0, -25)
JPBD_NCOP = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00012', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 2\[BDMV] Rising_Shield_Hero_S1P2_D1\BDMV\STREAM\00018', 24, -24)
...
def do_filter():
    ...
    deband = lvf.rfs(deband_a, deband_c, [(opstart, opstart+44)])
    deband = lvf.rfs(deband_a, core.std.MaskedMerge(deband_d, credit, dark_mask), [(opstart+1070, opstart+1103)])
    deband = lvf.rfs(deband_a, deband_d, [(opstart+1104, opstart+1124)])
    ...
    grain = lvf.rfs(grain, grain_original, [(10078, 10174), (29594, 29868)])
