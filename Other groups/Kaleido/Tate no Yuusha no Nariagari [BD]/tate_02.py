...
JPBD = infos_bd(r'[BDMV][190424][Tate no Yuusha no Nariagari][Vol.1]\TATE_1_1\BDMV\STREAM\00010', 0, -23)
JPBD_NCOP = infos_bd(r'[BDMV][190424][Tate no Yuusha no Nariagari][Vol.1]\TATE_1_2\BDMV\STREAM\00013', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 1\[BDMV] Rising_Shield_Hero_S1P1_D1\BDMV\STREAM\00015', 24, -24)
...
def do_filter():
    ...
    opstart, opend = 2997, 5154
    edstart, edend = 30928, 33084
    src = JPBD.src_cut
    src += src[-1]
    src = depth(src, 16)
