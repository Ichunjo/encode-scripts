...
JPBD = infos_bd(r'[BDMV][190626][Tate no Yuusha no Nariagari][Vol.3]\TATE_3_2\BDMV\STREAM\00011', 0, -24)
JPBD_NCOP = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00012', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 2\[BDMV] Rising_Shield_Hero_S1P2_D1\BDMV\STREAM\00019', 24, -24)
...
def do_filter():
    ...
    grain = lvf.rfs(grain, grain_original, [(14799, 15803), (16151, 16258), (20451, 20731),
                                            (21177, 21446), (21710, 22776), (24152, 24647), (24979, 25331)])
