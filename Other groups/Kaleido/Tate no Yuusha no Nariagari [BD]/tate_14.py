...
JPBD = infos_bd(r'[BDMV][190626][Tate no Yuusha no Nariagari][Vol.3]\TATE_3_1\BDMV\STREAM\00009', 24, -26)
JPBD_NCOP = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00012', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 2\[BDMV] Rising_Shield_Hero_S1P2_D1\BDMV\STREAM\00014', 24, -24)
...
def do_filter():
    ...
    grain = lvf.rfs(grain, grain_original, [(17317, 17462), (23522, 23687), (26771, 26902)])
