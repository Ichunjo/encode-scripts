...
JPBD = infos_bd(r'[BDMV][190724][Tate no Yuusha no Nariagari][Vol.4 Fin]\TATE_4_1\BDMV\STREAM\00011', 0, -24)
JPBD_NCOP = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00012', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 2\[BDMV] Rising_Shield_Hero_S1P2_D2\BDMV\STREAM\00014', 24, -24)
...
def do_filter():
    ...
    opstart, opend = 2014, 4184
    edstart, edend = 30943, 33099
    src = JPBD.src_cut
    src = depth(src, 16)
    ...
    deband_e = dbs.f3kpf(credit, 18, 48, 48)
    ...
    deband = lvf.rfs(deband, deband_e, [(9101, 9195), (11147, 11222), (11384, 11502),
                                        (12436, 12530), (13039, 13306), (14141, 14320),
                                        (14410, 14570), (15430, 15837), (16785, 17191),
                                        (17388, 17482), (19454, 19542), (19919, 20056),
                                        (20234, 20263)])
    ...
    grain = lvf.rfs(grain, grain_original, [(14998, 15184)])
