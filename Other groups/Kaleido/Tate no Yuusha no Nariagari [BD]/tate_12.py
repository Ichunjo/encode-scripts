...
JPBD = infos_bd(r'[BDMV][190524][Tate no Yuusha no Nariagari][Vol.2]\TATE_2_2\BDMV\STREAM\00010', 0, -25)
JPBD_NCOP = infos_bd(r'[BDMV][190424][Tate no Yuusha no Nariagari][Vol.1]\TATE_1_2\BDMV\STREAM\00013', 24, -24)
USBD = infos_bd(r'[BDMV] The Rising of the Shield Hero S01 Part 1\[BDMV] Rising_Shield_Hero_S1P1_D2\BDMV\STREAM\00019', 24, -24)
...
def do_filter():
    ...
    antialias_merged = lvf.rfs(antialias_merged, antialias_strong_a, [(4782, 4785)])
    antialias_merged = lvf.rfs(antialias_merged, antialias_strong_b, [(11808, 11898)])
