...
JPBD = infos_bd(r'[BDMV][201002][CYGX-00003]Princess Connect! Re_Dive Vol.3\BD_VIDEO\BDMV\STREAM\00001', 0, -25)
...
def do_filter():
    ...
    credit = lvf.rfs(credit, src, [(12121, 12192), (20819, 20878), (22007, 22066)])
    out = credit
