...
JPBD = infos_bd(r'[BDMV][200904][CYGX-00002][Princess Connect! Re_Dive Vol.2]\BD_VIDEO\BDMV\STREAM\00003', 0, -26)
...
def do_filter():
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, src, rescale_mask, 0),
                     [(opstart+425, opstart+698), (38290, src.num_frames-1)])
