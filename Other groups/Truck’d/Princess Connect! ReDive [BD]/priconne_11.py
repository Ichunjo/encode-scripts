...
JPBD = infos_bd(r'[BDMV][201106][CYGX-00004]Princess Connect! Re_Dive Vol.4\BD_VIDEO\BDMV\STREAM\00001', 0, -25)
...
def do_filter():
    ...
    kernel = 'lanczos'
    taps = 5
    opstart, opend = 840, 2996
    edstart, edend = 30138, 32296
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, src, rescale_mask, 0),
                     [(opstart+425, opstart+698), (33973, src.num_frames-1), (18689, 18736), (23890, 23911)])
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, src, creditless_mask, 0),
                     [(opstart, opend), (edstart, edend)])
    credit = lvf.rfs(credit, src, [(10865, 10924)])
    out = credit
