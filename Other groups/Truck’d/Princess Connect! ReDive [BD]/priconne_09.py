...
JPBD = infos_bd(r'[BDMV][201002][CYGX-00003]Princess Connect! Re_Dive Vol.3\BD_VIDEO\BDMV\STREAM\00002', 0, -26)
...
def do_filter():
    ...
    dehalo = gf.MaskedDHA(out, rx=2.8, ry=2.8, darkstr=0.4, brightstr=1.4, maskpull=48, maskpush=140)
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, src, rescale_mask, 0),
                     [(opstart+425, opstart+698), (33972, src.num_frames-1), (21962, 22009)])
