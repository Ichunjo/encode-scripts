...
JPBD = infos_bd(r'[BDMV][200807][CYGX-00001]Princess Connect! Re_Dive Vol.1\BD_VIDEO\BDMV\STREAM\00007', 0, -24)
...
def do_filter():
    ...
    logo_priconne = lvf.rfs(out, core.std.MaskedMerge(out, src, credit_mask, 0), [(opstart+425, opstart+698)])
    out = logo_priconne
