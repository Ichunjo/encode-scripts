...
JPBD = FileInfo(r'[BDMV][210519][Gotoubun no Hanayome ∬][Vol.3]\BDMV\STREAM\00005.m2ts', 0, -24,
...
class Filtering():
    def main(self) -> vs.VideoNode:
        ...
        bdchanges = lvf.rfs(out, bdchanges,
                            [(10189, 10344), (14801, 14978), (15119, 15202), (15403, 15486)])
        bdchanges = lvf.rfs(bdchanges, dering_src, [(28012, 28074), (28276, 28650), (28753, 29343),
                                                    (29401, 29601), (29902, 30189), (30475, 31569),
                                                    (31831, 32016), (32119, 32160), (32281, 32369)])
