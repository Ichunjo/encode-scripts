...
JPBD = FileInfo(r'[BDMV][210317][Gotoubun no Hanayome ∬][Vol.1]\BDMV\STREAM\00007.m2ts', 0, -24,
...
class Filtering():
    def main(self) -> vs.VideoNode:
        ...
        bdchanges = lvf.rfs(out, bdchanges, [(28222, 28299)])
        out = bdchanges
