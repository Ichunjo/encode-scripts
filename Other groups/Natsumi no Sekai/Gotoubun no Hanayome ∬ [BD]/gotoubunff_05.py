...
JPBD = FileInfo(r'[BDMV][210421][Gotoubun no Hanayome ∬][Vol.2]\BDMV\STREAM\00006.m2ts', 0, -24,
...
class Filtering():
    def main(self) -> vs.VideoNode:
        ...
        bdchanges = lvf.rfs(out, bdchanges,
                            [(4455, 4607), (4876, 5078), (5199, 5246),
                             (5958, 6035), (6894, 7076), (7275, 7406),
                             (7653, 7784), (7863, 7970), (8142, 8348),
                             (8784, 9065), (9276, 9800), (10613, 10720),
                             (10739, 10780), (10949, 10969), (11105, 11230),
                             (11924, 12289), (12865, 12891), (13139, 13213),
                             (15520, 15733), (19160, 19243), (20351, 20422),
                             (24824, 24979), (26357, 26527), (27920, 28000),
                             (29576, 29659), (29780, 29881), (30128, 30271),
                             (30644, 30763), (31776, 31811), (32522, 32641)])
        ...
        import rekt
        deband_c = rekt.rekt_fast(out, lambda x: vdf.placebo.deband(x, 18, 6, 2, 0), bottom=600)
