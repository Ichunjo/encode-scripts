...
JPBD = FileInfo(r'[BDMV][210421][Gotoubun no Hanayome ∬][Vol.2]\BDMV\STREAM\00007.m2ts', 0, -24,
...
class Filtering():
    def main(self) -> vs.VideoNode:
        ...
        bdweb = lvf.rfs(bdweb, src_web_y, [(64, 1413), (32034, 33195), (33465, 33881), (34174, 34524)])
        ...
        bdchanges = lvf.rfs(bdchanges, dering_src,
                            [(882, 902), (5596, 5701), (9909, 10064), (11804, 11864)])
        bdchanges = lvf.rfs(bdchanges, core.std.MaskedMerge(out, dering_src, diff_mask),
                            [(2534, 2682), (2840, 2887), (3188, 3271), (3818, 3859), (3986, 4087),
                             (4499, 4618), (5009, 5088), (14736, 14801), (15744, 15872), (17106, 17135),
                             (17913, 18143), (24247, 24438), (33196, 33329), (34021, 34173)])
