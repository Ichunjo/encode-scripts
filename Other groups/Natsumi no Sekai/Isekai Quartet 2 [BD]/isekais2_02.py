...
JPBD = infos_bd(r'Isekai Quartet S2\Vol1\BDROM\BDMV\STREAM\00006', 0, -24)
...
def do_filter():
    ...
    endcard = endcard_source(r'endcards\yande.re 603981 ass bikini breast_hold crossover horns isekai_quartet open_shirt overlord rem_(re_zero) swimsuits thong tsuji_santa weapon wings youjo_senki.jpg', src)
