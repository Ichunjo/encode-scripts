...
JPBD = infos_bd(r'Isekai Quartet S2\Vol1\BDROM\BDMV\STREAM\00008', 0, -24)
...
def do_filter():
    ...
    endcard = endcard_source(r'endcards\yande.re 607473 cheerleader isekai_quartet pointy_ears ram_(re_zero) rem_(re_zero) satou_kazuma seifuku tagme tanya_degurechaff trap youjo_senki.jpg', src)
