...
JPBD = infos_bd(r'Isekai Quartet S2\Vol2\BDROM\BDMV\STREAM\00008', 0, -24)
...
def do_filter():
    ...
    endcard = endcard_source(r'endcards\yande.re 619247 cleavage cocytus crossover dress emilia_(re_zero) isekai_quartet masha mecha neko overlord thighhighs uniform wings youjo_senki.jpg', src)
