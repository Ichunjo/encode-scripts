...
JPBD = infos_bd(r'Isekai Quartet S2\Vol2\BDROM\BDMV\STREAM\00005', 24, -24)
...
def do_filter():
    ...
    endcard = endcard_source(r'endcards\yande.re 613253 isekai_quartet.jpg', src)
    ...
    endcard = core.std.CropAbs(endcard, 1920, 1080, left=round((endcard.width - 1920)/2 / 2) * 2)
