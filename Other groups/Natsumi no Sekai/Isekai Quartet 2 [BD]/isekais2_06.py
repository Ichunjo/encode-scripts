...
JPBD = infos_bd(r'Isekai Quartet S2\Vol1\BDROM\BDMV\STREAM\00010', 0, -24)
...
def do_filter():
    ...
    endcard = endcard_source(r'endcards\yande.re 611483 isekai_quartet iwamoto_tatsurou maid ram_(re_zero) rem_(re_zero) sketch tanya_degurechaff tate_no_yuusha_no_nariagari uniform youjo_senki.jpg', src)
    ...
    endcard = core.resize.Bicubic(endcard, w, h, vs.YUV444PS, range_in=1, range=0, dither_type='error_diffusion')
