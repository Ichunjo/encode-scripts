...
WEB.idx = core.lsmas.LWLibavSource
WEB.set_infos(f'{NUM}/Edens Zero - {NUM} (Netflix VP9 1080p).mkv', 24, -24, preset='web/aac')
...
def do_filter():
    ...
    rescale = core.resize.Bicubic(upscale, 1920, 1080, src_left=.5, src_top=.5, filter_param_a=-.5, filter_param_b=.25)
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask),
                     [(2374, 4530), (4544, 4648), (4701, 4762), (30070, 30210), (31266, 33422)])
