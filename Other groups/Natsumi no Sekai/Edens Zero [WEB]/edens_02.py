...
WEB.set_infos(f'{NUM}/Edens Zero - {NUM} (Netflix 1080p).mkv', 24, -25, preset='web/aac')
...
def do_filter():
    ...
    denoise = hvf.SMDegrain(out, tr=3, thSAD=200, thSADC=200)
    out = denoise
    ...
    credit = lvf.rfs(credit, core.std.MaskedMerge(credit, ref, rescale_mask),
                     [(1152, 3308), (7492, 7604), (31173, 33422)])
