...
JPBD = infos_bd(r'[BDMV][201225][Choujigen Game Neptune The Animation Nep no Natsuyasumi]\BD\BDMV\STREAM\00004', 0, -48)
...
def do_encode(clip):
    ...
    if not os.path.isfile(JPBD.output):
        ...
        x265_cmd += '--psy-rd 1.85 --psy-rdoq 1.25 --no-open-gop --keyint 240 --min-keyint 23 --scenecut 60 --rc-lookahead 84 --bframes 12' + ' '
    ...
    print('\n\n\nAudio extraction')
    eac3to_args = ['eac3to', JPBD.src, '3:', JPBD.a_src.format(1)]
