...
JPBD = FileInfo2(
    r'[BDMV][211124][Magia Record S2][Vol.1]\BD\BDMV\STREAM\00005.m2ts',
    (0, -50),
    preset=[PresetBDWAV64, PresetOpus, PresetChapXML]
)
JPBD.name_clip_output = VPath('magia_bd_s2_03.265')
NCOP01 = FileInfo(
...
CRUNCHY = FileInfo(
    r'eps\[Élitiste] Magia Record - Puella Magi Madoka Magica Side Story Season 2 - The Eve of Awakening - 03.mp4',
    (-120, None)
)
...
OPSTART, OPEND = 1080, 3237
EDSTART, EDEND = 31289, 33446
...
class Filtering:
    ...
    def main(self, src: vs.VideoNode = JPBD.clip_cut) -> vs.VideoNode:
        ...
        aaa = remap_rfs(aaa, luma, [(31217, 31289), (OPSTART+425, OPSTART+545), (OPSTART+603, OPSTART+691)])
...
if __name__ == '__main__':
    ...
    DEBUG <<= core.ffms2.Source('magia_bd_s2_03.mkv')
    pass
