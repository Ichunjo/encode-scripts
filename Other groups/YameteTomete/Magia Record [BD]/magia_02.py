...
JPBD = infos_bd(r'[BDMV][200304][Magia Record][Vol.1]\BD_VIDEO\BDMV\STREAM\00002', 0, -48)
BLANK = 'blank.wav'
X264_ARGS = dict(
...
def do_filter():
    ...
    deband_c = core.std.MaskedMerge(deband, deband_b, kgf.squaremask(src, 630, 1080, 1290, 0))
    ...
    endcard = _perform_endcard('[BDMV][200304][Magia Record][Vol.1]/Scans/endcard2_front_descreen.png', src)
    endcard_length = 120
