...
JPBD = infos_bd(r'[BDMV][200902][Magia Record][Vol.5]\BD_VIDEO\BDMV\STREAM\00002', 0, -48)
X264_ARGS = dict(
...
def do_filter():
    ...
    def _perform_endcard(path: str, ref: vs.VideoNode)-> vs.VideoNode:
        ...
        endcard = core.std.CropRel(endcard, left=5, top=0, right=16, bottom=18)
        ...
        return Tweak(endcard, sat=1.4, cont=1.2).Add(1, constant=True)
    ...
    antialias_a = lvf.sraa(denoise, 1.5, 13)
    antialias = lvf.rfs(antialias, antialias_a, [(1176, 1235)])
    ...
    endcard = _perform_endcard(r'[BDMV][200902][Magia Record][Vol.5]\Scans\endcard12_front_descreen.png', src)
    endcard_length = 118
