...
JPBD = infos_bd(r'[BDMV][200408][Magia Record][Vol.2]\BD_VIDEO\BDMV\STREAM\00001', 0, -48)
BLANK = 'blank.wav'
X264_ARGS = dict(
...
def do_filter():
    ...
    def _perform_endcard(path: str, ref: vs.VideoNode)-> vs.VideoNode:
        ...
        endcard = core.std.CropRel(endcard, left=64, top=14, right=54, bottom=23)
    ...
    borders = lvf.rfs(grain, borders, [(18524, 18547), (18673, 18715),
                                       (18875, 18967), (19817, 19888)])



    endcard = _perform_endcard('[BDMV][200408][Magia Record][Vol.2]/Scans/endcard4_front_descreen.png', src)
    endcard_length = 120
