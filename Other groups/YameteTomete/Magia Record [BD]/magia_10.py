...
JPBD = infos_bd(r'[BDMV][200805][Magia Record][Vol.4]\BD_VIDEO\BDMV\STREAM\00003', 0, -48)
X264_ARGS = dict(
...
def do_filter():
    ...
    endcard = _perform_endcard('[BDMV][200805][Magia Record][Vol.4]/Scans/endcard10_front_descreen.png', src)
    endcard_length = 120
