...
JPBD = infos_bd(r'[BDMV][200805][Magia Record][Vol.4]\BD_VIDEO\BDMV\STREAM\00002', 0, -48)
X264_ARGS = dict(
...
def do_filter():
    ...
    endcard = _perform_endcard('[BDMV][200805][Magia Record][Vol.4]/Scans/endcard9_front_descreen.png', src)
    endcard_length = 119
    final = core.std.Splice([grain, muvf.SharpAAMcmod(depth(endcard, 16) * endcard_length, dark=2.5, thin=12, sharp=45)], True)
    ...
    return depth(final, 10)[33926+1:], endcard_length
    # return depth(grain, 10), None
