...
JPBD = infos_bd(r'[BDMV][200610][Magia Record][Vol.3]\BD_VIDEO\BDMV\STREAM\00001', 0, -48)
BLANK = 'blank.wav'
X264_ARGS = dict(
...
def do_filter():
    ...
    antialias_b = rekt_fast(denoise, lambda c: lvf.sraa(c, 1.45, rep=13, downscaler=downscaler), top=482)
    ...
    endcard = _perform_endcard('[BDMV][200610][Magia Record][Vol.3]/Scans/endcard6_front_descreen.png', src)
    endcard_length = 119
