...
def do_filter():
    ...
    # I gave up on this
    ending = lvf.rfs(out, dehardsub, [(1990, 4148), (31650, out.num_frames - 1)])
    out = ending
    ...
    ref = src_cru
    rsc_m = vdf.diff_rescale_mask(ref, 838, mthr=40)
    ...
    # Ep Title
    creds = [
        Credit([4232, 4347], vdf.region_mask(rsc_m[4329], 1200, 0, 0, 0)),
    ]
    for cred in creds:
    ...
    # return dehardsub, vdf.region_mask(rsc_m, 1200, 0, 0, 0)
