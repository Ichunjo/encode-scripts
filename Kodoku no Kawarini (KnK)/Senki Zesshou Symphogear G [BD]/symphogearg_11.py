...
JPBD = infos_bd(r'戦姫絶唱シンフォギアＧ\[BDMV][140305] 戦姫絶唱シンフォギアG 6\KIXA_90355\BDMV\STREAM\00003', 24, -24)
JPBD_NCOP = infos_bd_alt_alt(r'_assets\00008', 24, -24)
...
def do_filter():
    ...
    ncop = lvf.rfs(ncop, depth(src, 8)[opstart:opend+1], [(0, 79), (1035, 1037)])
    ...
    credit_mask = core.std.FreezeFrames(credit_mask, opstart+1685, opstart+1699, opstart+1684)
