...
JPBD = infos_bd_alt(r'戦姫絶唱シンフォギアＧ\[BDMV][140108] 戦姫絶唱シンフォギアG 4\KIXA_90353\BDMV\STREAM\00003', 24, -24)
...
def do_filter():
    ...
    opstart, opend = 1607, 4004
    edstart, edend = 31889, src.num_frames - 1
    full_stuff = [(4683, 4790), (17545, 17700)]
    ...
    upscale = vdf.fade_filter(upscale, upscale, upscale_smooth, 5044, 5067)
    upscale = vdf.fade_filter(upscale, upscale_smooth, upscale, 5068, 5103)
